...
namespace Drupal\neshama_registration\Plugin\WebformHandler;
 ...
 *
 * Attach this handler to the "neshama_registration" webform via Webform > Settings > Emails/Handlers > Add handler
 *
 * @WebformHandler(
 *   id = "neshama_participant_create",
...
class ParticipantCreateHandler extends WebformHandlerBase {
  ...
  public function postSave(WebformSubmissionInterface $webform_submission, $update = TRUE) {
    ...
    // Register file usage
    if ($file && $node->id()) {
      $this->fileUsage->add($file, 'neshama_registration', 'node', (int) $node->id());
    }
  }
}