...
namespace Drupal\neshama_registration\Plugin\Block;
 ...
 *
 * @Block(
 *   id = "neshama_registration_account_icon",
    ...
    if ($account->isAuthenticated()) {
      ...
      $build['#items'] = [
        [
          ...
          'url' => Url::fromRoute('neshama_registration.my_personal_data')->toString(),
        ],
        [
